...
//==============================================================
    ...
    $('#primary-nav li.menu-item-has-children, #primary-nav li.page_item_has_children').prepend('<i class="sub-menu-toggle"></i>');
     ...
     $( '.sub-menu-toggle' ).click(function(e) {
        ...
        if($(this).hasClass('menu-open')){
            ...
            $(this).parent('li.menu-item-has-children, li.page_item_has_children').children('ul').slideToggle();
            $(this).parent('li.menu-item-has-children, li.page_item_has_children').removeClass('active');
            ...
            $('.sub-menu-toggle').parent('li.menu-item-has-children, li.page_item_has_children').children('ul').slideUp();
            $(this).parent('li.menu-item-has-children, li.page_item_has_children').children('ul').slideToggle();
            $(this).parent('li.menu-item-has-children, li.page_item_has_children').removeClass('inactive');
            $(this).parent('li.menu-item-has-children, li.page_item_has_children').addClass('active');
            $(this).toggleClass('menu-open');
