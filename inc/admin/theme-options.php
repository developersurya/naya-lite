        ...
        <div id="sam-wrapper">
            <div id="header" class=" clearfix">
                ...
                <div class="sam-version">
                    <span><?php echo SAM_NAYA_LITE_VERSION; ?></span>
                </div>
            </div><!--end of #header-->
            <nav id="top-nav" class="clearfix">
                <ul class="external-links">
                    <li><a href="<?php echo esc_url(__('http://sampression.com/themes/naya-lite/#change-log','sampression')); ?>" target="_blank"><i class="icon-view-changes-log"></i><?php _e( 'VIEW CHANGE LOG', 'sampression' );?></a></li>
                    ...
                    <li><a href="<?php echo esc_url(__('https://support.sampression.com/hc/communities/public/topics/200171281-Naya-Lite','sampression')); ?>" target="_blank"><i class="icon-support-desk"></i><?php _e( 'VISIT SUPPORT DESK', 'sampression' );?></a></li>
                </ul>
            </nav>
            <!-- #top-nav-->
