...
//==============================================================
    ...
    // Append 'nav-height-col' only once after clicking '#trigger-primary-nav'
    ...
    if ($(window).width() < 767) {
        if ($('body')[0].addEventListener){
            ...
            if ( $( 'body' ).hasClass( 'show-nav' ) && !hasParent( e.target, 'primary-nav' ) ) {
                // Prevent default behaviour
                e.preventDefault();
    ...
    jQuery('#nav li.parent').append('<i class="sub-menu-toggle"></i>')
    jQuery('.sub-menu-toggle').click(function () {
        jQuery(this).parent('li.parent').children('ul').slideToggle();
    });
//==============================================================
// Tab Navigation
//==============================================================
